...
final class WPDKGlyphIcons extends WPDKObject {
  ...
  const SPIN1           = 'wpdk-icon-spin1';
  const SPIN2           = 'wpdk-icon-spin2';
  const SPIN3           = 'wpdk-icon-spin3';
  const SPIN4           = 'wpdk-icon-spin4';
  const SPIN5           = 'wpdk-icon-spin5';
  const SPIN6           = 'wpdk-icon-spin6';
