...
if( typeof( jQuery.fn.wpdkTooltip ) === 'undefined' ) {
  ...
  +function ($) {
    ...
    Tooltip.DEFAULTS = {
      ...
      placement: 'top',
      selector: false,
      template: '<div class="wpdk-tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>',
      trigger: 'hover focus',
      title: '',
      delay: 0,
      html: false,
    ...
    Tooltip.prototype.show = function () {
      ...
      if (this.hasContent() && this.enabled) {
        ...
        var complete = function() {
          that.$element.trigger('shown.wpdk.' + that.type)
        }
    ...
    Tooltip.prototype.hide = function () {
      ...
      function complete() {
        ...
        that.$element.trigger('hidden.wpdk.' + that.type)
      }
    ...
    $.fn.wpdkTooltip = function (option) {
      return this.each(function () {
        var $this   = $(this)
        var data    = $this.data('wpdk.wpdkTooltip')
        var options = typeof option == 'object' && option

        if (!data && option == 'destroy') return
        if (!data) $this.data('wpdk.wpdkTooltip', (data = new Tooltip(this, options)))
